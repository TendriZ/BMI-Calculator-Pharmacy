...
<section id="keunggulan">
  <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
    ...
    <div class="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
      <!-- Feature 1 -->
      <div class="rounded-2xl border border-salmon/30 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
...
<footer class="bg-white border-t border-salmon/20 mt-12">
      ...
      <div class="mt-12 lg:mt-0 lg:flex-1">
        <div class="grid grid-cols-2 gap-8 lg:grid-cols-5 lg:gap-y-16">
          ...
          <div class="col-span-2 sm:col-span-1">
            ...
            <ul class="mt-6 space-y-4 text-sm">
              <li><a href="#" class="text-dark/70 transition hover:text-maroon">Fara (Ketua Tim)</a></li>
              <li><a href="#" class="text-dark/70 transition hover:text-maroon">Anggota Dua</a></li>
              <li><a href="#" class="text-dark/70 transition hover:text-maroon">Anggota Tiga</a></li>
            </ul>
          </div>
          ...
          <div class="col-span-2 sm:col-span-1">
            ...
            <ul class="mt-6 space-y-4 text-sm">
              <li><span class="text-dark/70 block">Universitas XYZ</span></li>
              <li><span class="text-dark/70 block">Fakultas Farmasi</span></li>
              <li><span class="text-dark/70 block">Lab Pengembangan</span></li>
            </ul>
          </div>
          ...
          <div class="col-span-2 sm:col-span-1">
             ...
             <ul class="mt-6 space-y-4 text-sm">
               <li><a href="#" class="text-dark/70 transition hover:text-maroon">hello@glucadrop.com</a></li>
             </ul>
          </div>
          ...
          <ul class="col-span-2 flex flex-wrap justify-start gap-4 lg:col-span-5 lg:justify-end items-center mt-4 border-t border-salmon/20 pt-8 lg:mt-0 lg:border-0 lg:pt-0">
            ...
            <li>
              <a href="#" target="_blank" class="flex h-10 w-10 items-center justify-center rounded-full bg-cream text-maroon/70 transition hover:bg-maroon hover:text-white" title="LinkedIn Tim">
            ...
            <li>
              <a href="#" target="_blank" class="flex h-10 w-10 items-center justify-center rounded-full bg-cream text-maroon/70 transition hover:bg-maroon hover:text-white" title="Instagram Tim">
            ...
            <li>
              <a href="#" target="_blank" class="flex h-10 w-10 items-center justify-center rounded-full bg-cream text-maroon/70 transition hover:bg-maroon hover:text-white" title="Email Tim">
